...
namespace CHBHTH.Controllers
{
    ...
    {
        CHBHTH2Entities1 db = new CHBHTH2Entities1();
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (check == null)
                    {
                        ...
                        return RedirectToAction("~/Dangnhap");  // Điều hướng đến trang đăng nhập
                    }
                    else
                    {
                        // Nếu email đã tồn tại, yêu cầu người dùng nhập email khác
                ...
                {
                    // Nếu dữ liệu không hợp lệ, quay lại trang đăng ký
                    return View("Dangky");
                }
            }
            catch
